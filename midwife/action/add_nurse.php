...
try {
    ...
    if ($user_stmt->execute()) {
        ...
        // Insert data into the "midwife" table with the user ID as a foreign key
        $midwife_sql = "INSERT INTO midwife (user_id, first_name, last_name, birthdate, address) VALUES (?, ?, ?, ?, ?)";
        $midwife_stmt = $conn->prepare($midwife_sql);
        $midwife_stmt->bind_param("issss", $user_id, $first_name, $last_name, $birthdate, $address);
