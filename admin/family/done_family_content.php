...
WHERE fp_consultation.medicine != '' AND fp_information.is_deleted = 0"
;
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <button type="button" class="btn btn-success editbtn2"
                                            data-row-id="<?php echo $row['id']; ?>"><i class="fas fa-edit"></i> View
                                            Consultation </button>
                ...
                columnDefs: [
                    ...
                    { targets: 2, data: 'checkup_date' },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            var addButton = '<button type="button" class="btn btn-success editbtn2" data-row-id="' + row.id + '"><i class="fas fa-edit"></i> View Consultation </button>';
